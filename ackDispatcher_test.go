...
const (
	testAckSource       = "dns:external.com"
	testDestination     = "MAC:11:22:33:44:55:66"
	testTransactionUUID = "DEADBEEF"
	testAckContentType  = "ContentType"
	testAccept          = "Accept"
	testAckHeader1      = "Header1"
	testAckHeader2      = "Header2"
	testPath            = "/some/where/over/the/rainbow"
	testServiceName     = "ServiceName"
	testPartnerID       = "foo"
	testAckSuccess      = "Success"
	testAckMessageKey   = "message"
	testMetadataName    = "name"
	testMetadataValue   = "value"
	testURL             = "someURL.com"
	testSessionID       = "sessionID123"
)
		...
		// Failure case
		{
			...
			event: &device.Event{
				...
				Message: &wrp.Message{
					...
					Source:                  testAckSource,
					Destination:             testDestination,
					TransactionUUID:         testTransactionUUID,
					ContentType:             testAckContentType,
					Accept:                  testAccept,
					Status:                  &expectedStatus,
					RequestDeliveryResponse: &expectedRequestDeliveryResponse,
					Headers:                 []string{testAckHeader1, testAckHeader2},
					Metadata:                map[string]string{testMetadataName: testMetadataValue},
					Spans:                   [][]string{{"1", "2"}, {"3"}},
...
func testAckDispatcherOnDeviceEventQOS(t *testing.T) {
	...
	*/
	...
	tests := []struct {
		...
		{testAckSuccess, testAckDispatcherOnDeviceEventQOSSuccess},
